...
class Agent(Base_Agent):
    def __init__(self, host:str, agent_port:int, monitor_port:int, unum:int,
        ...
        self.init_pos = ([-14,0],[-9,-5],[-9,0],[-9,5],[-5,-5],[-5,0],[-5,5],[-1,-6],[-1,-2.5],[-1,2.5],[-1,6])[unum-1] # formação inicial
    ...
    def think_and_send(self):
        ...
        if PM == w.M_GAME_OVER:
            ...
            if r.unum == 9:
                self.kick(120,3) # não há necessidade de alterar o estado quando o PM não estiver em Play On
            else:
