...
script.batch_create(Agent, ((a.i, a.p, a.m, a.u, a.t,        True, True),)) #um jogador para o time da casa
script.batch_create(Agent, ((a.i, a.p, a.m, a.u, "Opponent", True, True),)) #um jogador para o time visitante
