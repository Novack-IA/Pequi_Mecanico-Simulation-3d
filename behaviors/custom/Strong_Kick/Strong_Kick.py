    ...
    def execute(self,reset, direction, abort=False) -> bool: # You can add more arguments 
        ...
        if self.phase == 0: 
            ...
            if (w.ball_last_seen > t - w.VISUALSTEP_MS and ang_diff < 5 and       # ball is visible & aligned
                ...
                return self.behavior.execute_sub_behavior("Kick_Motion_strong", True)#novo sub-behavior strong
            else:
            ...
            return self.behavior.execute_sub_behavior("Kick_Motion_strong", False)#novo sub-behavior strong
